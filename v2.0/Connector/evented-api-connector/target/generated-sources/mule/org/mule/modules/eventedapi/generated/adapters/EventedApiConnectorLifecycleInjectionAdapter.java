...
/**
 * A <code>EventedApiConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link EventedApiConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2018-02-13T08:01:58-05:00", comments = "Build UNNAMED.2793.f49b6c7")
public class EventedApiConnectorLifecycleInjectionAdapter
    extends EventedApiConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(EventedApiConnectorLifecycleInjectionAdapter.class);
