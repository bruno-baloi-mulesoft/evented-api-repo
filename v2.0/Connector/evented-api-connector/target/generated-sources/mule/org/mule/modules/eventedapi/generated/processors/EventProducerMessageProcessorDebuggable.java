...
public class EventProducerMessageProcessorDebuggable
    extends EventProducerMessageProcessor
    implements DebugInfoProvider
{


    public EventProducerMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("subject", "Subject", (java.lang.String.class), subject, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("message", "Message", (java.lang.Object.class), message, muleEvent));
